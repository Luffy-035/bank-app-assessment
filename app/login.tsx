...
export default function LoginScreen() {
  ...
  const segmentRef = useRef<View>(null);

  useEffect(() => {
    if (segmentWidth > 0) {
      Animated.spring(slideAnim, {
        toValue: loginMethod === 'phone' ? 0 : segmentWidth + 6, // 3px padding on each side + gap
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      {loginMethod === 'email' && (
        <View style={styles.inputContainer}>
          <TextInput
            ...
            autoCapitalize="none"
            defaultValue="demo@crib.in"
          />
          <TextInput
            style={[styles.emailInput, { marginTop: 16 }]}
      ...
      <View style={styles.socialContainer}>
        ...
        <TouchableOpacity style={styles.socialButton}>
          <Image
            source={require('@/assets/images/Facebook - normal.png')}
            style={styles.socialLogo}
            contentFit="contain"
          />
        </TouchableOpacity>
